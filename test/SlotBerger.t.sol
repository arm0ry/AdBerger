...
import {SlotBerger} from "../src/SlotBerger.sol";

contract SlotBergerTest is Test {
    SlotBerger slotBerger;
    ...
    function setUp() public payable {
        vm.prank(alice);
        slotBerger = new SlotBerger(alice);
    }

    function testReceiveETH() public payable {
        (bool sent, ) = address(slotBerger).call{value: 5 ether}("");
        assert(sent);
    }
}
